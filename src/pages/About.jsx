...
export const About = () => {
  return (
    ...
    <div className='main-container mt-8 flex flex-col w-[90%] m-auto gap-10 md:gap-28 max-w-[425px] md:max-w-[830px] lg:gap-32 xl:gap-36 '>
                  <div className="title text-black text-center  text-3xl md:text-[34px] lg:text-[36px] xl:text-[40px] 2xl:text-[44px]">About us</div>

        <div className="about-us     relative flex flex-col justify-center gap-4 items-center md:flex-row md:gap-8 xl:gap-12">
